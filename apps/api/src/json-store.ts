...
/**
 * The pre-SQLite JSON-file persistence, kept only so `scripts/import-json.ts`
 * can read an old data file into the database. The live store is `Store` in
 * `store.ts`. Also home of the seed data and session types both stores share.
 */
